...
?>
            ...
            <form class="text-dark" method="POST">
             <!--<h1><?php echo date("Y-d-m H:i:s");?></h1> -->
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-4">
                        <label class="control-label" for="nomorTelpon">Support</label>
                        <select name="nomorTelpon" class="form-control mb-2">
                            <?php
    ...
    <?php
       ...
       if(isset($_POST['nomorTelpon'], $_POST['mulaiCuti'], $_POST['akhirCuti'], $_POST['alasanCuti'])) {
            ...
            $query = "INSERT INTO wp_cuti (nama_karyawan, divisi, email, nomor_telpon, mulai_cuti, akhir_cuti, alasan_cuti, jumlah_hari, waktu_pengajuan) VALUES ('$namaKaryawanBaru', '$divisi', '$user_email', '$nomorTelpon', '$mulaiCuti', '$akhirCuti', '$alasanCuti', '$selisihHari', '$waktuPengajuan')";
