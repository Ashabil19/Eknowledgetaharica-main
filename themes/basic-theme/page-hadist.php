   ...
   <?php
    ...
    <section class="page">
        <div class=" container-fluid text-light container ">
            ...
            <?php
                ...
                $args02 = array(
                    'post_type' => 'hadist', // Replace 'your_custom_post_type' with your actual custom post type slug
    ...
    if ($query->have_posts()) {
        ...
        foreach ($posts_by_category as $kategori => $posts) {
            ...
            echo '</a>';
           echo '<a class="btn btn-warning mb-3 ml-1" href="https://eknowledge.taharica.co.id/categories/?kategori=' . esc_attr($kategori) . '" target="_blank" >More...</a>'; // Target URL based on category
            echo '</div>';
