...
if (strpos($_SERVER['REQUEST_URI'], '/login') !== false) {
   ...
   <?php
            ...
            } elseif ($role == "hr" && strpos($current_page, "hrd") !== false) {
    ...
    <section class="page">
        <div class=" container-fluid text-light container ">
            ...
            <?php
                ...
                $args02 = array(
                    'post_type' => 'hrd', // Replace 'your_custom_post_type' with your actual custom post type slug
            ...
            <div class="container my-5 text-dark custom-bg-transparent">
    <?php
    // WP_Query arguments
    $args = array(
        'post_type' => 'hrd', // Replace 'your_custom_post_type' with your actual custom post type slug
    ...
    if ($query->have_posts()) {
        ...
        foreach ($posts_by_category as $kategori => $posts) {
            ...
            echo '</a>';
            echo '<a class="btn btn-warning mb-3 ml-1" href="$home_url/categories/?kategori=' . esc_attr($kategori) . '" target="_blank" >More...</a>'; // Target URL based on category
            echo '</div>';
