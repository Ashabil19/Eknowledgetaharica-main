<form role="search" style="width:70%;" class="d-flex justify-content-center align-items-center" method="get" class="search-form" action="<?php echo esc_url(home_url('/')); ?>">

        <input type="search" style="height:40px;" class="search-field" placeholder="Your Favorite" value="<?php echo get_search_query(); ?>"  required />
